...
from src.regression.music_va.modules import Conv_2d, Conv_emb, Res_2d_mp, Res_2d
...
#        self.layer1 = Res_2d(1, ndim, stride=2)
#        self.layer2 = Res_2d(ndim, ndim, stride=2)
#        self.layer3 = Res_2d(ndim, ndim*2, stride=2)
#        self.layer4 = Res_2d(ndim*2, ndim*2, stride=2)
#        self.layer5 = Res_2d(ndim*2, ndim*2, stride=2)
#        self.layer6 = Res_2d(ndim*2, ndim*2, stride=2)
#        self.layer7 = Res_2d(ndim*2, ndim*4, stride=2)
