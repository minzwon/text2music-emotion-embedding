...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='isear', choices=['isear', 'alm'])
    parser.add_argument('--is_weighted', type=bool, default=True)
    ...
    parser.add_argument('--num_branches', type=int, default=3, choices=[2, 3])
